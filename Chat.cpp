...
void frnd::chat_on(string uname,string reciepient,char *message) { 
 ...
 strcpy(sms[reciepient].mess[sms[reciepient].num_of_message],cuname);  strcat(sms[reciepient].mess[sms[reciepient].num_of_message],": ");  strcat(sms[reciepient].mess[sms[reciepient].num_of_message],message);  sms[reciepient].num_of_message++; 
} 
...
{ 
 ...
 string addname;
 cout<<"\nEnter the name which you want to add in your friend list"<<endl;  cin>>addname; 
...
{ 
 ...
 i=flist.begin(); 
 cout<<"\nWelcome "<<uname<<" Your Friends are:"<<endl;  for(;i!=flist.end();i++) 
 {
 cout<<"\n"<<*i<<endl; 
 c++; 
 } 
...
break; 
 ...
 f[reciepient].chat_on(uname,reciepient,message);  cout<<"\nYour message has been sent\n"; 
 cout<<"\npress any number except '0' to go back to main menu\n";  cin>>choice3; 
 if(choice3) 
 goto main_menu; 
 break; 
 ...
 { 
 char message[100]; 
 cout<<"\nPlease Type Your message :"<<endl;  cin.ignore(); 
 cin.getline(message,100); 
